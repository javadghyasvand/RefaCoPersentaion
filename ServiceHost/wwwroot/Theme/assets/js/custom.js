...
function AddtoCard(id, name, price, picture,slug) {
...
function updateCart() {
    ...
    products.forEach(x => {
        const product = `<div class="single-cart-item">
                            ...
                            <div class="image">
                                <a asp-page="./ProductDetails" asp-route-id="${x.slug}">
                            ...
                            <div class="content">
                                <p class="product-title">
                                    <a  asp-page="./ProductDetails" asp-route-id="${x.slug}">محصول: ${x.name}</a>
                                </p>
...
function changeCartItemCount(id, totalId, count) {
    ...
    var newPrice = parseInt(product.unitPrice) * parseInt(count);
